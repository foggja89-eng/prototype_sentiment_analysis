...
public class Menu //Beginning of class Menu
{
    ...
    * @throws byte choice, any numerical menu selection made by the user will be handled by this. 
    * @throws IOException 
    */
   public void menuSystem(BufferedReader stdin) throws IOException
   {
    start();
   ...
   public void option1(Input input, ErrorList error, BufferedReader stdin) throws IOException
   {
    ...
    //Set up a new process for the python script to run sentiment analysis. 
